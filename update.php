					...
					<div class="join_wrap">	
						...
						<p class="join_txt">금강컨트리클럽을 이용하시기 불편함 없도록 밝고 건강한 새로운 소식을 회원님께 알려드립니다.</p>
                                        ...
                                        <form action="board_update.php" method="post">
                                            ...
                                            <label for="board_title" class="b1">제목<input type="text" id="board_title" name="title" value="<?=$result['title']?>"class="b1_input">
                                            <input type="textarea"  name="content" value="<?=$result['content']?>" class="b1_textarea">  
                                            <div class="btn_wrap">
                                                <button type="submit" class="sp_sub btn_next">수정완료<button>					
                                            </div>
                                        </form>
			</div>	
		</div>	
