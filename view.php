				...
				<div class="right_con">	
					...
					<div class="join_wrap">	
						...
						<p class="join_txt">금강컨트리클럽을 이용하시기 불편함 없도록 밝고 건강한 새로운 소식을 회원님께 알려드립니다.</p>
                                    <table id="view">
                                        <tr class="view_tr">
                                            <td>제목 : <?=$result["title"]?></td><td>조회수:<?=$result["count"]?></td>
                                        </tr>
                                        <tr class="view_tr">
                                            <td>작성자:<?=$result["name"]?></td><td>작성일:<?=$result["date"]?></td>
                                        </tr>
                                        <tr class="view_tr"><td>내용</td><td><?=$result["content"]?></td></tr>
                                    </table>
                                                <p><a href="/update.php?idx=<?=$result['idx']?>">수정</a></p>
                                                   <p><a href="/delete.php?idx=<?=$result['idx']?>">삭제</a></p>  
