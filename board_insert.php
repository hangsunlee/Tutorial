	...
	<div id="header">	
		...
		<div id="site_menu">
			...
			<li class="menu5">
				...
				<li><a href="sub1.php" class="sp_com site_menu5_2">자료실</a></li>
					...
					<div class="join_wrap">	
						...
						<p class="join_txt">금강컨트리클럽을 이용하시기 불편함 없도록 밝고 건강한 새로운 소식을 회원님께 알려드립니다.</p>
                                        ...
                                        <form action="write.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <p>
                                            	<label for="board_title" class="b1">제목<input type="text" id="board_title" name="title" class="b1_input">
                                            </p>
                                            <p>
                                                <label for="board_name" class="b1">작성자<input type="text" id="board_name" name="name"class="b1_input">    
                                            </p>
                                            <input type="textarea"  name="content" class="b1_textarea">  
                                            <p><label  for="upload">첨부파일:<input type="file" id="upload" name="uploadfile">
                                            <div class="btn_wrap">
